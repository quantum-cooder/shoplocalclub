...
class DottedLineDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const SizedBox(
      ...
      child: CustomPaint(
        painter: LinePainter(
          firstOffset: Offset(0, 1),
          secondOffset: Offset(double.infinity, 1),
...
class LinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawDashedLine(dashLength, dashSpace, firstOffset,
        Offset(size.width, firstOffset.dy), canvas, size, paint);
  }
